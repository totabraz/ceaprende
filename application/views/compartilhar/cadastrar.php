<div class="share-register-screen container">
  ...
  <div class="row">
    <div class="col-xs-12 col-md-8 share-screen__register-form">
      <!-- general form elements -->
      <div class="box box-primary">
        <!-- <div class="box-header with-border">
          <h3 class="box-title">Cadastrar conteúdo</h3>
        </div> -->
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form">
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Resposta 1.1:</label>
              <input type="text" class="form-control" placeholder="Enter ...">
            </div>
            <div class="form-group">
              <label>Resposta 1.2:</label>
              <input type="text" class="form-control" placeholder="Enter ...">
            </div>
            <div class="form-group">
              <label>Resposta 1.3:</label>
              <input type="text" class="form-control" placeholder="Enter ...">
            </div>
            <div class="form-group">
              <label>Resposta 1.4:</label>
              <input type="text" class="form-control" placeholder="Enter ...">
            </div>
          </div>
          <!-- /.box-body -->
